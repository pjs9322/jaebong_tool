...
// 뷰어 모드가 아닌 에디터 모드인데 모바일로 접속한 경우 유지보수(maint.html) 페이지로 리다이렉션
...
<?php endif; ?>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-WEDM8MYGQC"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'G-WEDM8MYGQC');
    </script>
</head>
            ...
            <div class="col" id="step1Panel">
                ...
                <div class="col-bd">
                    <div style="margin-bottom:12px;">
                        <div style="font-size:12px; font-weight:800; color:#555; margin-bottom:6px;">홈페이지 주소로 자동 캡처
                        </div>
                        <input type="text" id="urlCaptureIn" class="url-input" placeholder="https://..."
                            style="width:100%; box-sizing:border-box;">
                        <button class="btn-black" id="btnUrlCapture" style="width:100%; margin-top:8px; padding:12px; font-size:13px;">홈페이지 찾기</button>
                    </div>
                ...
                <div class="canvas-controls" style="display:none;">
                    <div>
                        ...
                        <input type="text" class="url-input" id="urlIn"
                            placeholder="수정할 페이지의 위치(주소)를 입력해주세요 (예: https://...)">
                    </div>
                </div>
...
예시) 이미지는 추후 전달드리겠습니다, 이미지 직접 수급 부탁드립니다, www.susunzip.com 해당 레퍼런스 참고하여 디자인 리뉴얼 부탁드립니다."></textarea>
                        ...
                        <div class="center-action-row">
                            <div class="cat-wrapper" style="margin-right:12px; padding:4px; background:transparent;">
                                <div class="cat-bar" style="grid-template-columns: repeat(4, 1fr); gap:6px;">
...
예시) 고객센터 -> 고객문의로 변경해주세요."></textarea>
    ...
    <div class="layer" id="captureLayer" style="background: rgba(243, 244, 246, 0.9); backdrop-filter: blur(8px); z-index: 10000; display:none; flex-direction:column; align-items:center; justify-content:center; position:fixed; inset:0;">
        <div class="load-card" style="width: 420px; padding: 60px 40px; text-align:center;">
            ...
            <p class="sub-title" style="margin-bottom: 0; font-size: 14px; opacity: 0.7;">홈페이지를 검색하고, 분석하여, 캡쳐해 옵니다.<br>페이지 길이에 따라 최대 1분이 소요될 수 있습니다.</p>
        </div>
    </div>
